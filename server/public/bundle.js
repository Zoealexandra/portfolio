...
var Body = function (_React$Component) {
  ...
  _createClass(Body, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _apiClient.getAllProjects)().then(function (projects) {
...
var BASE_ROUTE = exports.BASE_ROUTE = '/api/v1/route';
var PROJECT_ROUTE = exports.PROJECT_ROUTE = BASE_ROUTE + '/projects';

function getAllProjects() {
  return _superagent2.default.get(PROJECT_ROUTE + '/').then(function (res) {
    return res.body;
  });
}
